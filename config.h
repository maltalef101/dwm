...
static Key keys[] = {
  ...
  // #---# letterkey bindings #---#
    ...
    { MODKEY|ShiftMask,             XK_w,       spawn,          SHCMD("st -c 'weatherreport' -g 640x408 -e less -S .local/share/weatherreport") },
  ...
  /* !!! J and K are bound up in the STACKKEYS macro !!! */
    ...
    { MODKEY|ShiftMask,             XK_v,       spawn,          SHCMD("st -c pulsemixer -g 110x27 -e pulsemixer") },
